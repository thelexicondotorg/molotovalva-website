...
| **Phase 5** | `3,800px – 4,500px` | 700px | **Subheading reveal**:<br>• `3,800px – 4,100px` (300px): `#subheading-part1` fades in (`y: 8 -> 0`).<br>• `4,100px – 4,200px` (100px): Stillness hold.<br>• `4,200px – 4,500px` (300px): `#subheading-part2` "(It's in your contract's fine print.)" (non-italic) fades in (`y: 8 -> 0`). |
